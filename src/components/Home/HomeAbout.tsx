            ...
            <section>
                <div className="py-10">
                    <div className="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-16">
                        <div className=" border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-gray-600/10 lg:p-16 rounded-[4rem] space-y-6 md:flex md:gap-6 justify-center md:space-y-0 lg:items-center">
                            ...
                            <div className="md:7/12 lg:w-1/2">
                                ...
                                <p className="my-8 text-slate-900 dark:text-gray-300 text-justify">
