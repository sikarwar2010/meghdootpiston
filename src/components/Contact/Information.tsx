						...
						<div className="divide-y divide-gray-200 dark:divide-gray-800">
							...
							<div className="flex gap-x-7 py-6">
								...
								<div>
									...
									<a
										...
										href="#"
									>
                                        6, Industrial Estate, Nunhai, Agra-282006, INDIA
									</a>
								</div>
							</div>
							{/* <!-- End Icon Block --> */}
							...
							<div className="flex gap-x-7 py-6">
								...
								<div>
									...
									>
                                        <span className="">
                                            29, Industrial Estate, Nunhai, Agra-282006, INDIA
                                        </span>
									</a>
								</div>
							</div>
							...
							<div className=" flex gap-x-7 py-6">
								...
								<div>
									...
									<p className="mt-1 text-sm text-gray-500">
										If you wish to write us over the phone call.
									</p>
									<a
										className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
										href="#"
									>
										...
										<span className="">9719029044</span> |
										<span className="">9760415467</span> |
										<span className="">05622990513</span>
									</a>
								</div>
							</div>
							{/* <!-- End Icon Block --> */}
